...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.CoverRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.GalleryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/gift": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "List rekening/e-wallet",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.GiftRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/hero": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "URL gambar hero",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.HeroRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.InvitationRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.OpeningRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/story": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Gambar + list cerita",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.StoryRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "entity.EventRequest": {
            ...
            "properties": {
                "events": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.EventEntryRequest"
                    }
                },
                "title": {
                    "type": "string"
        ...
        "entity.GalleryRequest": {
            "type": "object",
            "properties": {
                "galleries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.GalleryEntryRequest"
                    }
                }
            }
        },
        "entity.GiftEntryRequest": {
            "type": "object",
            "properties": {
                "no": {
                    "type": "string"
        ...
        "entity.GiftRequest": {
            ...
            "properties": {
                "gifts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.GiftEntryRequest"
                    }
                }
            }
        },
        ...
        "entity.StoryRequest": {
            ...
            "properties": {
                "stories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.StoryEntryRequest"
                    }
                },
                "storyImgUrl": {
                    "type": "string"
